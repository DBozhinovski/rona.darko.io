...
[OpenStreetMap](https://nominatim.openstreetmap.org/reverse) for a country name to show you the local data. It doesn't track you 
or anything, we're not trying to be creepy here :) Also, it's very much FOSS, so please,
have a look yourself - https://github.com/DBozhinovski/rona.darko.io
...
and <s>WHO</s> - UPDATE: WHO changed their reports (again), so I'm not going to use those anymore. The data gathering method respectively: crawling, reading their JSON report,
and finally parsing their godawfully formatted PDF reports. [That was fun](https://blog.darko.io/posts/rona-tracker/).
